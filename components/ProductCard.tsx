...
import { ShoppingCart, Tag, Package, Building2, Calendar, Check, Loader2 } from 'lucide-react';
        ...
        <CardFooter className="pt-0">
          {showAddToBill && isAuthenticated ? (
            ...
            <Button
              ...
              onClick={() => {
                // Could be used for quick view or other actions for non-authenticated users
              }}
            >
              View Details
            </Button>
