        ...
        <div className="relative aspect-[4/5] overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div className="absolute top-2 left-2 right-2 flex justify-between items-start">
            ...
            <button
              ...
              className={`p-2 rounded-full backdrop-blur-sm transition-all duration-200 ${isFavorited
              ...
              <div className="flex space-x-1">
                {selectedColor.urls.map((_, index) => (
                  <button
                    ...
                    className={`w-1.5 h-1.5 rounded-full transition-all ${index === currentImageIndex ? 'bg-white scale-125' : 'bg-white/50'
                      }`}
                  />
                ))}
              </div>
                              ...
                              <div className="grid grid-cols-3 gap-2">
                                {availableSizes.map((size) => (
                                  <button
                                    ...
                                    className={`p-2 text-sm border-2 rounded-lg font-medium transition-all duration-200 ${selectedSize === size
